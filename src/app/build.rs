    ...
    pub(super) fn main_layout(
        ...
        ui.with_layout(egui::Layout::left_to_right(egui::Align::TOP), |ui| {
            ...
            if self.copilot.visible {
                let selected_text = match &self.content {
                    Content::PlainText(ref es) => Some(es.selected_text()),
                    _ => None,
                };
                copilot::build_copilot_panel(&mut self.copilot, &self.config, selected_text, ui);
            }
        })
    }
}
